    ...
    <div className='max-w-[1520px] m-auto text-white px-4 bg-[#24262b]'>
      <div className='mx-auto grid lg:grid-cols-3'>
        <div className='lg:col-span-2 my-4'>
          ...
          <p>
          Sign up for our newsletter to receive weekly recipe inspiration, exclusive offers, and culinary insights straight to your inbox.          </p>
        </div>
        <div className='my-4 '>
          <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
            ...
            />
            <button className='bg-pink-600 py-3 text-white rounded-md font-medium w-[200px] ml-4 my-6 px-6 border-none'>
              Call Me
            </button>
          </div>
